...
%%%%%PLOT zL
      if ~isempty(zL)     %plot zL when it's there
          plot(z2G(zL)+1e-6+1e-6*j,'Color','g','.','MarkerSize',10);
...
%%%DESIGN A STAGE%%%%%%%%%%%%%%%%%%%%%%%%%%%
      if (design_F) %% DESIGN A STAGE
       ...
       if ~isempty(zL)  %Once zL is entered
          ...
          set (h.advanced_current_G_label,"string", sprintf("GIN= %.2f /_ %.1f",real(G_in),imag(G_in)));
          set (h.advanced_current_Gt_label,"string", sprintf("Gt= %.2f /_ %.1f",a,b));
       endif
...
h.z_in_element_select_popup = uicontrol  ("visible", "off","style", "popupmenu", "units",
                                  "normalized", "string",
                                 {"Series Reactance jx", "Shunt Admitance jb","Line Displacement"},
                                 "callback", @update_plot,
                                    "position", [0.30 0.30 0.25 0.05]);
h.element_select_popup = uicontrol  ("style", "popupmenu", "units", "normalized","string",
                                 {"Series Reactance jx",
                                 "Shunt Admitance jb",
                                 "Wave/4 Tx",
                                 "Line displacement"},
...
h.sign_select_label = uicontrol ("style", "text",
                                  "units", "normalized",
                                  "string", "sign",
                                  "horizontalalignment", "left",
                                  "position", [0.20 0.35 0.06 0.05]);

h.sign_select_popup = uicontrol ("style", "popupmenu",
                                  "units", "normalized",
                                  "string", {"+","-"},
                                  "callback", @update_plot,
                                  "position", [0.20 0.30 0.06 0.05]);
%%%%%% BEGIN ADVANCED CONTROLS
h.enable_presets_checkbox = uicontrol ("visible", "off",
                                        "style", "checkbox",
                                        "units", "normalized",
                                        "string", "Enable Presets",
                                        "horizontalalignment", "center",
                                        "position", [0.00 0.05 0.20 0.05]);
h.enable_presets_lable = uicontrol ("visible", "off",
                                    "style", "text",
                                    "units", "normalized",
                                    "string", "for T or PI match",
                                    "horizontalalignment", "center",
                                    "position", [0.00 0.00 0.20 0.05]);

h.advanced_enable_checkbox = uicontrol ("style", "checkbox",
                                        "units", "normalized",
                                        "string", "advanced design ",
                                        "callback", @update_plot,
                                        "position", [0.20 0.25 0.15 0.05]);
%%%%%%RADIO BUTTON GROUP START
h.advanced_bg = uibuttongroup ("position", [ 0.20 0 0.25 0.25],
                                "visible","off");
h.Gselect = uicontrol (h.advanced_bg, "style", "radiobutton",
                                      "string", "Gt select",
                                      "units","normalized",
                                      "Position", [0.0 0.66 1 0.33]);
h.Qselect = uicontrol (h.advanced_bg, "style", "radiobutton",
                                      "string", "Qn w/ this ele",
                                      "units", "normalized",
                                      "Position", [ 0.0 0.33 1 0.33]);
h.Circleselect = uicontrol (h.advanced_bg, "style", "radiobutton",
                                            "string", "hit r/g circle",
                                            "units", "normalized",
                                            "Position", [ 0.0 0.00 1 0.33]);
%%%%%%%%%ADVANCED RADIO BUTTON GROUP END
h.Gt_select_bg = uibuttongroup ("position", [ 0.40 0.15 0.28 0.10],
                                "visible","off");
...
h.adv_Gt_reset_rb = uicontrol (h.Gt_select_bg,  "style", "radiobutton",
                                "units", "normalized",
                                "visible", "on", "string", "set to Gs/Gl ",
                                "callback", @update_plot,
                                "position", [0 0 1 0.50]);


%% DISPLAY CURRENT IMPEDANCE ADMITTANCE
h.advanced_current_z_label = uicontrol ("style", "text",
                                        "units", "normalized",
                                        "string", "zIN=",
                                        "horizontalalignment", "left",
                                        "position", [0.45 0.10 0.20 0.05]);
h.advanced_current_y_label = uicontrol ("style", "text",
                                        "units", "normalized",
                                        "string", "yIN=",
                                        "horizontalalignment", "left",
                                        "position", [0.65 0.10 0.20 0.05]);
h.advanced_current_G_label = uicontrol ("style", "text",
                                        "units", "normalized",
                                        "string", "GammaIN=",
                                        "horizontalalignment", "left",
                                        "position", [0.65 0.05 0.20 0.05]);
h.advanced_current_Gt_label = uicontrol ("style", "text",
                                          "units", "normalized",
                                          "string", "Gtarget=",
                                          "horizontalalignment", "left",
                                          "position", [0.45 0.05 0.20 0.05]);
%%HERE---------------------------------------------------------------
